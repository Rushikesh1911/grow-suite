  ...
  const plans = [
    {
      name: 'Starter',
      price: '₹0',
      description: 'Kickstart your journey with essential features',
      buttonText: 'Get Started Free',
      featured: false,
      features: [
        { name: '5 active projects', included: true },
        { name: 'Basic analytics dashboard', included: true },
        { name: 'Community forum support', included: true },
    ...
    },
    {
      ...
      featured: true,
      features: [
        { name: '20 active projects', included: true },
        ...
        { name: 'Standard security compliance', included: true },
        { name: '4-hour response time', included: true },
      ],
    },
    {
      name: 'Enterprise',
      ...
      featured: false,
      features: [
        { name: 'Unlimited projects & resources', included: true },
        { name: 'Advanced analytics with custom metrics', included: true },
        { name: '24/7 Priority support with SLAs', included: true },
        { name: 'Unlimited API access', included: true },
